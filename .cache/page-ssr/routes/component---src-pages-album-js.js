...
const Album = props => {
  ...
  const singleArtist = async props => {
    ...
    try {
      ...
      /* eslint-disable */console.log(...oo_oo(`2606111092_32_6_32_24_4`, error));
    }
    try {
      setArtist(finalResults);
    } catch (error) {
      /* eslint-disable */console.log(...oo_oo(`2606111092_38_6_38_24_4`, error));
    }
  };
