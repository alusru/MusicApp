...
const API = `${cors_api_host}https://api.deezer.com/`;
...
/* harmony import */ var _globals_Global__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../globals/Global */ "./src/globals/Global.js");
...
}, siteTitle)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.Button, {
...
const Layout = ({
  ...
  }, "Gatsby"), " |", " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", {
...
/* harmony export */   AlbumCover: () => (/* binding */ AlbumCover),
/* harmony export */   AlbumSides: () => (/* binding */ AlbumSides),
/* harmony export */   AlbumSmallTextDescription: () => (/* binding */ AlbumSmallTextDescription),
/* harmony export */   AlbumTableData: () => (/* binding */ AlbumTableData),
/* harmony export */   AlbumTitle: () => (/* binding */ AlbumTitle),
/* harmony export */   ArtistImageInAlbum: () => (/* binding */ ArtistImageInAlbum),
/* harmony export */   ArtistNameInAlbum: () => (/* binding */ ArtistNameInAlbum),
/* harmony export */   BadgeNewAlbum: () => (/* binding */ BadgeNewAlbum),
...
/* harmony export */   LiTrackList: () => (/* binding */ LiTrackList),
...
`;
const CardContainer = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div`
    position: relative;
    display: -ms-flexbox;
    display: flex;
...
`;
const Button = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])((0,gatsby__WEBPACK_IMPORTED_MODULE_0__.Link))`
...
`;
const CardBody = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div`
-ms-flex: 1 1 auto;
    flex: 1 1 auto;
    min-height: 1px;
    padding: 1.25rem;
`;
const CardTitle = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].h5`
    margin-bottom: .75rem;
    font-weight: 500;
    line-height: 1.2;
    font-size: 1.25rem;
`;
const AlbumTitle = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].h5`
margin-bottom: .75rem;
    font-weight: 500;
    line-height: 1.2;
    font-size: 1.25rem;
...
`;
const ArtistImageInAlbum = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img`
    border-radius: 42px;
`;
const AlbumSmallTextDescription = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].ul`
    display: flex;
    margin: 0;
    font-size: 14px;
`;
const AlbumSides = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div`
    display: inline-flex;
    vertical-align: top;
    
`;
const ArtistNameInAlbum = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])((0,gatsby__WEBPACK_IMPORTED_MODULE_0__.Link))`
margin-top: 12px;
margin-left: 12px;
`;
const AlbumContainer = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div`
    margin: 0 12px;
`;
const Cardtext = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].p`
    ...
    margin-bottom: 1rem;
`;
const AlbumCover = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].img`
    width: 35%;
    border-radius: 60%;
    position: relative;
    top: 14px;
`;
const AlbumTableData = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].td`
width: 40%;
    padding: 0;
    font-size: 12px;
    margin: 0;
    line-height: 0;
`;
const TrackList = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].ul`
list-style: none;
margin: 0;
`;
const LiTrackList = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].li`
display: flex;
...
`;
const DataTable = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].table`
color: #000;
`;
const BadgeNewAlbum = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].span`
color: #fff;
...
/* harmony import */ var react_audio_player__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-audio-player */ "./node_modules/react-audio-player/dist/bundle.js");
...
const Album = props => {
  ...
  const singleArtist = async props => {
    let finalResults = [];
    try {
      const data = axios__WEBPACK_IMPORTED_MODULE_7__["default"].get(`${_components_API__WEBPACK_IMPORTED_MODULE_1__.API}album/${props.id}`);
      finalResults = (await data).data;
    } catch (error) {
      /* eslint-disable */console.log(...oo_oo(`346004308_32_6_32_24_4`, error));
    }
    try {
      setArtist(finalResults);
    } catch (error) {
      /* eslint-disable */console.log(...oo_oo(`346004308_38_6_38_24_4`, error));
    }
  };
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    singleArtist(props);
  }, [props]);
  const today = dayjs__WEBPACK_IMPORTED_MODULE_5___default()();
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_3__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_seo__WEBPACK_IMPORTED_MODULE_4__["default"], {
    title: "Album"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.Container, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.Row, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.Column, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
    src: artist.cover_big,
    alt: artist.title
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.Column, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.AlbumContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.AlbumTitle, null, artist && artist.title, " ", days && days <= 7 ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.BadgeNewAlbum, null, "NEW") : ""), artist && ((_artist$contributors = artist.contributors) === null || _artist$contributors === void 0 ? void 0 : _artist$contributors.map(contributor => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.AlbumSides, {
    key: contributor.id
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.ArtistImageInAlbum, {
    src: contributor.picture_small,
    alt: contributor.name
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.ArtistNameInAlbum, {
    to: `/artist/${contributor.id}`
  }, contributor.name)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.AlbumSmallTextDescription, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.LiTrackList, null, artist && artist.nb_tracks > 1 ? `${artist && artist.nb_tracks} tracks` : `${artist && artist.nb_tracks} track`, " "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.LiTrackList, null, Math.floor((artist && artist.duration / 60) / 60), " hrs", " ", Math.round(artist && artist.duration / 60) - Math.floor((artist && artist.duration / 60) / 60) * 60, " ", "mins"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.LiTrackList, null, artist && artist.release_date), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.LiTrackList, null, artist && artist.fans, " fans"))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.Row, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.Column, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globals_Global__WEBPACK_IMPORTED_MODULE_2__.DataTable, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("thead", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th", null, "Track"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th", null, "Duration"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("th", null, "Preview"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tbody", null, artist && artist.tracks.data.map(item => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tr", {
    key: item.id
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", null, " ", item.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", null, " ", Math.floor(item.duration / 60), ":", item.duration - Math.floor(item.duration / 60) * 60), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("td", null, " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react_audio_player__WEBPACK_IMPORTED_MODULE_6___default()), {
    src: item.preview,
    controls: true,
    style: {
      width: "190px",
  ...
  }))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("tfoot", null)))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("small", null, artist && artist.release_date.slice(0, 4), " | ", artist && artist.label)));
};
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"data":{"site":{"siteMetadata":{"title":"MusicApp"}}}}');
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"data":{"site":{"siteMetadata":{"title":"MusicApp","description":"Kick off your next, great Gatsby project with this default starter. This barebones starter ships with the main Gatsby configuration files you might need.","author":"@gatsbyjs"}}}}');
