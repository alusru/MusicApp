...
module.exports = (api, args, defaultReturn, argTransform) => {
  if (!apis[api]) {
    /* eslint-disable */
    console.log(...oo_oo(`3128187443_18_4_18_46_4`, `This API doesn't exist`, api));
...
try {
  ...
  if (testRequireError(`../src/html`, err)) {
    ...
    /* eslint-disable */
    console.log(...oo_oo(`751622268_22_4_22_78_4`, `There was an error requiring "src/html.js"\n\n`, err, `\n\n`));
    process.exit();
  }
}
